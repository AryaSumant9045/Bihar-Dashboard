...
async function connectWarRoom() {
  ...
  try {
    ...
    if (!response.ok) throw new Error('Live news backend is unavailable. Start backend/server.py on port 8000.');
